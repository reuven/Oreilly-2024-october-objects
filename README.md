# Notebooks, files, and programs from "Object-oriented bootcamp"

This repo contains the Jupyter notebook + program files from my training for O'Reilly on October 14-15, 2024.  It'll remain open, so you can review the material later on.
